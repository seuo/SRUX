                        ...
                        <row className="row2">
                            <itemheading>
                                ...
                                <text className="skills">
                                    ...
                                    <p>They also wanted the website to be designed for results, they were getting
                                        the traffic but not the conversion rate. I came up with a solution by designing
                                        more of a one page site with the most important features at the top that
                                        customers would be interested in. By creating an eye catching call to action &
                                        displaying the instructors directly below, heliboard.nz has had a large
                                        improvement in conversions from the booking system.
                                    </p>
                                </text>
                        ...
                        <row className="row2">
                            <itemheading>
                                ...
                                <text className="skills">
                                    ...
                                    <p>These renders & floor plans were created for a draftsman so they could show
                                        the client and give them a better idea & visual of what their finished home will
                                        look like.</p>
